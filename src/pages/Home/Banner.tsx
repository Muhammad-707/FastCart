...
export default function Banner({
  ...
  return (
    <div className="bg-black w-full h-[500px] lg:h-[420px] lgLpy-0 py-20 flex flex-col md:flex-row items-center justify-center md:justify-between px-6 md:px-10 text-white rounded-4xl overflow-hidden">
