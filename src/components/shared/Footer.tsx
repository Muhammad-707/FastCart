...
export default function Footer() {
  return (
    <footer className="w-full bg-black text-white font-sans pt-16 pb-6 mt-auto">
      {/* Главный контейнер: на мобилках flex-col (в одну колонку), на десктопе grid из 5 колонок */}
      <div className="max-w-[1400px] mx-auto px-6 flex flex-col md:grid md:grid-cols-5 gap-8 text-left pb-12 border-b border-zinc-800">
        ...
        {/* Контейнер-обёртка для блоков Account и Quick Link, чтобы на мобилке они встали в два ряда рядышком как на фото */}
